...
class M4Conan(ConanFile):
    ...
    def generate(self):
        ...
        # otel-distro-php: disabled warings to pass build with GCC 15
#        env.define("CXX", "false")
#        env.define("CXXCPP", "false")
        env.append("CFLAGS", " -std=gnu11 -Wno-error")
        env.append("CPPFLAGS", " -Wno-error")
