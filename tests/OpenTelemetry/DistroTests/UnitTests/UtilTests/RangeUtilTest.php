...
class RangeUtilTest extends TestCase
{
    public function testGenerate(): void
    {
        ...
        $generateAsArray = function (int $begin, int $end, int $step = 1): array {
            return IterableUtil::toList(RangeUtil::generate($begin, $end, $step));
        };
        ...
        self::assertTrue(IterableUtil::isEmpty(RangeUtil::generate(1000, 1000)));
        self::assertFalse(IterableUtil::isEmpty(RangeUtil::generate(1000, 1001)));

        self::assertSame(0, IterableUtil::count(RangeUtil::generate(1000, 1000)));
        self::assertSame(1, IterableUtil::count(RangeUtil::generate(1000, 1001)));
    }
    ...
    public function testGenerateDown(): void
    {
        ...
        $generateDownAsArray = function (int $begin, int $end, int $step = 1): array {
            return IterableUtil::toList(RangeUtil::generateDown($begin, $end, $step));
        };
        ...
        self::assertTrue(IterableUtil::isEmpty(RangeUtil::generateDown(1000, 1000)));
        self::assertFalse(IterableUtil::isEmpty(RangeUtil::generateDown(1001, 1000)));

        self::assertSame(0, IterableUtil::count(RangeUtil::generateDown(1000, 1000)));
        self::assertSame(1, IterableUtil::count(RangeUtil::generateDown(1001, 1000)));
    }
    ...
    public function testGenerateUpTo(): void
    {
        ...
        $generateUpToAsArray = function (int $count): array {
            return IterableUtil::toList(RangeUtil::generateUpTo($count));
        };
    ...
    public function testGenerateFromToIncluding(): void
    {
        ...
        $generateFromToIncludingAsArray = function (int $begin, int $end): array {
            return IterableUtil::toList(RangeUtil::generateFromToIncluding($begin, $end));
        };
