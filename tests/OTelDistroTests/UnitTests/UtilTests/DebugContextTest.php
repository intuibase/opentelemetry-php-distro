...
use OTelDistroTests\Util\DebugContextConfig;
use OTelDistroTests\Util\DebugContextScope;
use OTelDistroTests\Util\IterableUtil;
use OTelDistroTests\Util\JsonUtil;
use OTelDistroTests\Util\Log\LoggableToString;
use OTelDistroTests\Util\MixedMap;
use OTelDistroTests\Util\Pair;
...
use function OTelDistroTests\dummyFuncForTestsWithNamespace;

use const OTelDistroTests\DUMMY_FUNC_FOR_TESTS_WITH_NAMESPACE_CONTINUATION_CALL_LINE;
use const OTelDistroTests\DUMMY_FUNC_FOR_TESTS_WITH_NAMESPACE_FILE;
use const OTelDistroTests\DUMMY_FUNC_FOR_TESTS_WITH_NAMESPACE_FUNCTION;
...
class DebugContextTest extends TestCaseBase
{
    ...
    public function testTrimVendorFrames(MixedMap $testArgs): void
    {
        ...
        self::assertNotNull($testFuncLine); // @phpstan-ignore staticMethod.alreadyNarrowedType
        ...
        if ($nonVendorCallsDepth >= 4) {
            ...
            self::assertScopeDesc(
                ...
                class:           null,
                function:        OTEL_PHP_TESTS_DUMMY_FUNC_FOR_TESTS_WITHOUT_NAMESPACE_FUNCTION,
                file:            OTEL_PHP_TESTS_DUMMY_FUNC_FOR_TESTS_WITHOUT_NAMESPACE_FILE,
                line:            OTEL_PHP_TESTS_DUMMY_FUNC_FOR_TESTS_WITHOUT_NAMESPACE_CONTINUATION_CALL_LINE,
            );
