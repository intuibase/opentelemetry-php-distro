...
final class StackTraceUtil
{
    ...
    private const OTEL_PHP_FQ_NAME_PREFIX = 'OpenTelemetry\\Distro\\';
    private const OTEL_PHP_INTERNAL_FUNCTION_NAME_PREFIX = '';
    ...
    public function __construct(
        ...
        string $namePrefixForFramesToHide = self::OTEL_PHP_FQ_NAME_PREFIX,
        string $namePrefixForInternalFramesToHide = self::OTEL_PHP_INTERNAL_FUNCTION_NAME_PREFIX
    ) {
     ...
     */
    public function captureInClassicFormat(int $offset = 0, ?int $maxNumberOfFrames = null, bool $keepOTelDistroFrames = true, bool $includeThisObj = false, bool $includeArgs = false): array
    {
     ...
     * @return ClassicFormatStackTraceFrame[]
     */
    public function convertCaptureToClassicFormat(array $phpFormatFrames, int $offset, ?int $maxNumberOfFrames, bool $keepOTelDistroFrames, bool $includeThisObj, bool $includeArgs): array
    {
