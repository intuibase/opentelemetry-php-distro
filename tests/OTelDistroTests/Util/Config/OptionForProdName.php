...
enum OptionForProdName
{
    ...
    private static function optNameToEnvVarPrefix(): array
    {
        return [
            ...
            self::inferred_spans_enabled->name            => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::inferred_spans_min_duration->name       => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::inferred_spans_reduction_enabled->name  => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::inferred_spans_sampling_interval->name  => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::inferred_spans_stacktrace_enabled->name => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::log_file->name                          => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
            self::log_level_file->name                    => self::OTEL_PHP_ENV_VAR_NAME_PREFIX,
