...
use OTelDistroTests\Util\LimitedSizeCache;
use ReflectionClass;
...
final class LoggableToJsonEncodable
{
    ...
    private const OTEL_NAMESPACE_PREFIXES = ['OpenTelemetry\\Distro\\', 'OTelDistroTests\\'];
    ...
    private static function isFromDistroNamespace(string $fqClassName): bool
    {
        foreach (self::OTEL_NAMESPACE_PREFIXES as $prefix) {
